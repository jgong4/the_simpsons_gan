...
dataroot = "~/course/LITR0110D/Images"
...
# pause = input("Data visaulization has been shown. Continue? (yes/no)")
# while pause != "yes":
#     pause = input("Data visaulization has been shown. Continue? (yes/no)")
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("loss_plot_500_actual.png")
# plt.show()

# pause = input("Plot has been shown. Continue? (yes/no)")
# while pause != "yes":
#     pause = input()
...
ani.save("500_epoch.gif", writer = "imagemagick", fps = 5)
# plt.show()
